...
from ..analysis.cost import _build_cells_with_centers, _evaluate_path
from ..core.models import MRRCell
from ..core.topology import Path, RNBTopology
...
def _cost_from_perm_z(
    ...
    from ..analysis.cost import _logsumexp_scaled
